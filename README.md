...
```javascript
dtypes = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/array-typed-real-dtypes@v0.1.1-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/array-typed-real-dtypes/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/array-typed-real-dtypes/actions/workflows/test.yml?query=branch:v0.1.1
